     ...
     <section className={styles.CampaginBanner}>
       ...
       <div className="slide-2">
          <div className="container">
            ...
            <div className="banner__form">
              <div className="banner__form-fields">
                <label className='d-mob' htmlFor="banner">Please select your credit range</label>
              <select>
                <option selected="" value="780" name="740+">740+</option>
                <option value="730" name="720-730(Very Good)">720-730(Very Good)</option>
                <option value="710" name="700-719(Good)">700-719(Good)</option>
                <option value="690" name="680-699(Above Average)">680-699(Above Average)</option>
                <option value="670" name="660-679(Average)">660-679(Average)</option>
                <option value="650" name="640-659(Below Average)">640-659(Below Average)</option>
                <option value="0630" name="620-639(Fair)">620-639(Fair)</option>
       ...
       <div className="slide-3">
          <div className="container">
            <div className="banner__hero">
              <h1 className='d-mob'>Thank you Name, and regarding the property</h1>
            ...
            <div className="banner__form">
              <div className="banner__form-fields">
                ...
                <select>
                <option selected="" value="780" name="Single Family Home">Single Family Home</option>
                <option value="730" name="720-730(Very Good)">720-730(Very Good)</option>
                <option value="710" name="700-719(Good)">700-719(Good)</option>
                <option value="690" name="680-699(Above Average)">680-699(Above Average)</option>
                <option value="670" name="660-679(Average)">660-679(Average)</option>
                ...
                <select>
                <option selected="" value="780" name="740+">Primary Residence</option>
                <option value="730" name="720-730(Very Good)">720-730(Very Good)</option>
                <option value="710" name="700-719(Good)">700-719(Good)</option>
                <option value="690" name="680-699(Above Average)">680-699(Above Average)</option>
                <option value="670" name="660-679(Average)">660-679(Average)</option>
       ...
       <div className="slide-4">
          <div className="container">
            <div className="banner__hero">
              ...
              <h2 className='d-mob'>Tell us a bit more about your property and current loan</h2>
            </div>
            <div className="banner__form">
              <div className="banner__form-fields">
                <div className="banner__select">
